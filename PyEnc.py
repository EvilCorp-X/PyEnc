...
#Author: Innominate-Web
# Coder: Innominate-Web
...
def logo():
    ...
    print("\033[94m│    \033[92m▘  ▗▄▘▀▀▘▘ ▘▝▀ ▘  ▗▄▘▌   ▀ ▝▀ ▘  \033[94m   │".center(column1))
    print("\033[94m│                                        │".center(column2))
    print("\033[94m│ \033[95mAuthor : Innominate-Web.                \033[94m│".center(column1))
    print("\033[94m│ \033[95mTool   : Encode Python2 and Python3    \033[94m│".center(column1))
    print("\033[94m│ \033[95mGitHub : https://github.com/innominate-web \033[94m│".center(column1))
    print("\033[94m│ \033[95mCoder  : Innominate-Web            \033[37mV3.0 \033[94m│".center(column3))
    print("\033[94m└────────────────────────────────────────┘".center(column2))
